...
export default function Navbar() {
  ...
  return (
    ...
    <nav className="sticky top-0 z-50 bg-white/80">
      <div className="max-w-10xl mx-auto px-8 py-3 flex items-center justify-between relative">
        {/* Logo */}
        ...
        <button onClick={() => setOpen(!open)} className="p-2">
          <span className="block w-8 h-8 text-black text-2xl leading-none">
            &#9776;
          </span>
        </button>
        ...
        {open && (
          <div
            className="absolute right-11 top-14 bg-gray-100 min-w-[130px] py-2 z-50"
          ...
          >
            ...
            <button
              ...
              className="block w-full text-left px-4 py-1 hover:bg-gray-100 hover-staatliches"
            >
              Contact
            </button>
          </div>
